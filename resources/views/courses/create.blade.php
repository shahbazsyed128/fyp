                ...
                <div class="col-sm-4">
                    ...
                    <label class="col-form-label" for="inputName"><i class="fas fa-book"></i> Course Name</label> 
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" placeholder="Course Name" class="form-control" value="">
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    ...
                    <label class="col-form-label" for="inputEmail"><i class="fas fa-book"></i> Course Type</label> 
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="type" placeholder="Course Type" value="" class="form-control">  
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    ...
                    <label class="col-form-label" for="inputEmail"><i class="fas fa-book"></i> Course Subject</label> 
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="subject" placeholder="Course Subject" value="" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <label class="col-form-label" for="description"><i class="fas fa-book"></i> Description</label>  
                       <textarea name="description" id="description" placeholder="Description" class="form-control" rows="4"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="price" placeholder="Course Price" value="" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
 ...
 var count = 0;
    ...
    $('.form-upload').ajaxForm({
        ...
        success: function(response) {
            ...
            html+='<div class="col-sm-1"><button class="bg-transparent  border-0" onclick="deletevideo('+count+')"><i class="fa fa-trash text-danger mt-4"></i></button></div></div>';
